...
const athenaCenturion: MixTape = {
  ...
  songFile: 'https://barcommissie.nl/centurion/athena-centurion.mp3',
  coverUrl: '',
  duration: 6006,
  feed: [
    {
